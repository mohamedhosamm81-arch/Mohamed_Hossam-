...
export default function HeroSection({ onNavigate, onOpenAuth }: HeroProps) {
  const floatingCards = [
    { name: 'Maya Chen', teaching: 'React', learning: 'Spanish', avatar: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100', verified: true, delay: '' },
    { name: 'Carlos Rivera', teaching: 'UX Design', learning: 'Python', avatar: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100', verified: true, delay: 'animation-delay-300' },
    { name: 'Aisha Patel', teaching: 'Yoga', learning: 'Web Dev', avatar: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=100', verified: true, delay: 'animation-delay-600' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-slate-300 text-xl leading-relaxed mb-10 max-w-lg">
              Mind2Mind connects experts for genuine skill exchange. Teach guitar, learn Spanish.
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-base font-medium text-white/90 border border-white/20 hover:bg-white/10 transition-all duration-200"
              >
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 space-y-4">
                <div className="text-center mb-6">
                  <div className="text-slate-400 text-sm mb-1">Active Exchanges Right Now</div>
                  <div className="text-4xl font-bold text-white">2,847</div>
                  <div className="text-teal-400 text-sm mt-1">↑ 12% from last week</div>
                </div>
                ...
                {floatingCards.map((card, i) => (
                  ...
                  >
                    <div className="relative flex-shrink-0">
                      <img src={card.avatar} alt={card.name} className="w-12 h-12 rounded-xl object-cover" />
                      {card.verified && (
